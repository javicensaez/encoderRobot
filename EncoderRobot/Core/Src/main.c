...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : ENC2B_Pin ENC2A_Pin ENC1A_Pin ENC1B_Pin
                           ENC4B_Pin ENC4A_Pin ENC3A_Pin ENC3B_Pin */
  GPIO_InitStruct.Pin = ENC2B_Pin|ENC2A_Pin|ENC1A_Pin|ENC1B_Pin
                          |ENC4B_Pin|ENC4A_Pin|ENC3A_Pin|ENC3B_Pin;
